...
| 2 | `README.md#L99-L125`, `README.md#L131` |
...
| 9 | `app/auth/dependencies.py#L50-L69`, `app/chat/router.py#L162-L172`, `README.md#L168` |
| 10 | `app/ui/templates/chat.html#L28-L60`, `app/ui/templates/chat.html#L68-L103`, `app/ui/templates/chat.html#L105-L123`, `app/ui/static/chat.js#L197-L205`, `app/ui/static/chat.js#L207-L239` |
...
| 12 | `app/chat/models.py#L49-L97`, `app/chat/repository.py#L141-L195`, `docs/spec/db/DB.md#L145-L172` |
...
| 15 | `app/chat/router.py#L71-L74`, `app/chat/i18n.py#L7-L34`, `docs/spec/api/API.md#L174-L207` |
| 16 | `app/chat/schemas.py#L13-L31`, `app/ui/static/chat.js#L135-L148`, `README.md#L208-L210`, `README.md#L290-L300` |
| 17 | `app/chat/schemas.py#L13-L60`, `app/chat/router.py#L41-L78`, `app/chat/service.py#L67-L164`, `app/chat/openai_client.py#L19-L65`, `app/chat/repository.py#L13-L65` |
| 18 | `README.md#L136-L151`, `README.md#L154-L162` |
| 19 | `app/chat/schemas.py#L13-L60`, `docs/spec/api/API.md#L231-L286` |
...
| 21 | `app/chat/models.py#L49-L97`, `app/chat/repository.py#L13-L65`, `app/chat/repository.py#L68-L138`, `app/chat/repository.py#L198-L241` |
...
| 28 | `app/chat/openai_client.py#L26-L37`, `app/chat/openai_client.py#L48-L65`, `docs/spec/ai/AI.md#L56-L73` |
| 29 | `README.md#L353-L383`, `README.md#L385-L387` |
| 30 | `app/chat/models.py#L49-L97`, `app/chat/router.py#L61-L67`, `app/chat/repository.py#L141-L195`, `docs/spec/db/DB.md#L48-L65` |
...
- 변경 함정 숫자 상한: 실수형 48개 + 정수형 76개 = 124개

근거 숫자 증가량만큼 정수형 함정 숫자를 34개 줄여 기본 장면의 전체 숫자 상한을 유지한다.
좁은 화면에서 124개를 모두 무충돌로 배치할 공간이 없으면 함정 숫자만 추가로 생략한다. 근거 숫자와
잠금 해제 숫자는 생략하지 않는다.
...
1. 1부터 31까지 모든 문항이 존재하고 총 근거 블록이 96개인지 검사한다.
